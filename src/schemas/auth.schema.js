...
const loginSchema = Joi.object({
  email: Joi.string()
    ...
    .messages({
      ...
      [JOI_ERROR_KEYS.STRING_EMPTY]: VALIDATION_MESSAGES.EMAIL_REQUIRED,
  ...
  password: Joi.string()
    ...
    .messages({
      ...
      [JOI_ERROR_KEYS.STRING_EMPTY]: VALIDATION_MESSAGES.PASSWORD_REQUIRED,
...
const registerSchema = Joi.object({
  ...
  password: Joi.string()
    ...
    .messages({
      ...
      [JOI_ERROR_KEYS.STRING_PATTERN_BASE]: VALIDATION_MESSAGES.PASSWORD_PATTERN_INVALID,
      [JOI_ERROR_KEYS.STRING_EMPTY]: VALIDATION_MESSAGES.PASSWORD_REQUIRED,
      'any.required': VALIDATION_MESSAGES.PASSWORD_REQUIRED
    }),
  ...
  confirmPassword: Joi.string()
    ...
    .messages({
      ...
      [JOI_ERROR_KEYS.STRING_EMPTY]: VALIDATION_MESSAGES.PASSWORD_CONFIRMATION_REQUIRED,
