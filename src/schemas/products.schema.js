...
const productSchema = Joi.object({
  title: Joi.string()
    ...
    .messages({
      ...
      [JOI_ERROR_KEYS.STRING_MIN]: VALIDATION_MESSAGES.PRODUCT_TITLE_MIN,
      [JOI_ERROR_KEYS.STRING_MAX]: VALIDATION_MESSAGES.PRODUCT_TITLE_MAX
    }),
  ...
  description: Joi.string()
    ...
    .messages({
      ...
      [JOI_ERROR_KEYS.STRING_MIN]: VALIDATION_MESSAGES.PRODUCT_DESCRIPTION_MIN,
